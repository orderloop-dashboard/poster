...
//     return (
//         <div className="min-w-[200px] h-[300px] relative">
//             <div className="absolute top-0 bg-yellow-100 w-full p-2">
...
export function Frame1(props) {
    ...
    return (
        <>
            <div className={`border border-neutral-300 relative w-[320px] h-[320px] mx-auto flex`} onClick={onClick}>
